...
const Navbar = () => {
  ...
  return (
    <div className={`fixed z-[999] w-full px-6 sm:px-10 md:px-15 py-4 sm:py-6 md:py-7 font-["Neue Montreal"] flex justify-between items-center transition-transform duration-300 ease-in-out ${
