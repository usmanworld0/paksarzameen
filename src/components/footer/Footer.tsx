      ...
      <div className="store-container relative py-16 sm:py-20">
        <div className="md:hidden">
          <div className="pb-7 text-center">
            <h3 className="text-[3.2rem] font-normal leading-none tracking-[0.08em] text-neutral-950">
              PAKSARZAMEEN
            </h3>
          </div>
          ...
          <div className="border-y border-black/10">
            <details className="border-b border-black/10 last:border-b-0">
              <summary className="flex cursor-pointer list-none items-center justify-between px-0 py-4 text-[1.68rem] text-neutral-950 [&::-webkit-details-marker]:hidden">
                Navigation
                <span className="text-[1.92rem] leading-none text-neutral-900">+</span>
              </summary>
        ...
        <div className="hidden grid-cols-1 gap-10 md:grid lg:grid-cols-[1.2fr_repeat(3,minmax(0,1fr))] lg:gap-12">
          <div>
            ...
            <h3 className="mt-3 text-[3.2rem] font-normal leading-[1] tracking-[-0.03em] text-neutral-950 sm:text-[3.76rem]">
              Pak<span className="text-[#0f7a47]">Sar</span>Zameen
            </h3>
            <p className="mt-4 max-w-md text-[1.4rem] leading-7 text-neutral-600">
          ...
          <nav aria-label="More links">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/policies" className="text-[1.4rem] text-neutral-600 transition-colors duration-300 hover:text-neutral-950">
                  Policies &amp; Terms
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-[1.4rem] text-neutral-600">
              <li>{siteConfig.contact.email}</li>
              <li>{siteConfig.contact.phone}</li>
              <li>{siteConfig.contact.address}</li>
              <li>
