  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8 text-center">
        ...
        <h2 className="mt-2 text-[clamp(2.2rem,5vw,3.5rem)] font-black uppercase leading-[0.9] tracking-tighter text-[#111111]">Email OTP</h2>
        <p className="mt-2 text-sm font-medium text-[#707072]">Enter your email to receive a one-time code and continue to your dashboard.</p>
      </div>
        ...
        {step === "email" ? (
          ...
          >
            <label className="block space-y-1.5">
              <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#707072]">Email address</span>
              <input
                type="email"
                required
                autoComplete="email"
            ...
            <button
              type="submit"
              disabled={sending}
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#111111] py-2.5 text-xs font-semibold uppercase tracking-[0.14em] text-white transition hover:bg-[#333] disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          >
            <div className="rounded-xl border border-[#E5E5E5] bg-[#f3f3ee] px-4 py-3 text-xs font-medium text-[#707072]">
              Code sent to <span className="font-semibold text-[#111111]">{normalizedEmail}</span>
            </div>

            <label className="block space-y-1.5">
              <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#707072]">6-digit OTP</span>
              <input
                type="text"
                required
                inputMode="numeric"
                ...
                className="w-full rounded-xl border border-[#E5E5E5] bg-white px-4 py-2.5 text-center text-xl tracking-[0.35em] text-[#111111] outline-none transition placeholder:text-[#bbb] focus:border-[#0f7a47] focus:ring-2 focus:ring-[#0f7a47]/10"
                placeholder="000000"
              />
            </label>
            ...
            <div className="flex items-center justify-between gap-3">
              <button
                ...
                className="inline-flex items-center gap-1 text-xs font-semibold text-[#0f7a47] hover:text-[#1a9d5f]"
              >
              ...
              <button
                ...
                className="text-xs font-semibold text-[#0f7a47] hover:text-[#1a9d5f] disabled:cursor-not-allowed disabled:opacity-50"
              >
